...
ALL_SNAPSHOTABLE_OBJS = EDITABLE_GGRC_OBJ + DISABLED_OBJECTS
...
ALL_CA_OBJS = EDITABLE_CA_OBJS + DISABLED_OBJECTS

EDITABLE_OBJS_W_CUSTOM_ROLES = EDITABLE_GGRC_OBJ + (
    PROJECTS, ASSESSMENTS, DOCUMENTS, EVIDENCE, ISSUES, AUDITS, PROGRAMS)

ALL_OBJS_W_CUSTOM_ROLES = EDITABLE_OBJS_W_CUSTOM_ROLES + DISABLED_OBJECTS
